...
def add_db():
    ...
    try:
        ...
        messagebox.showinfo(
            "Error", "Cannot add given book data into Database")
...
def addBooks():
    ...
    submitbtn = Button(window, text="Submit", command=add_db,
                       bg="DodgerBlue2", fg="white", font=('arial', 15, 'bold'))
